<div class="mob-nav toggle">
	...
	<div class="cess-nav">
		...
		<a href="create"><div class="logo grid-col grid-col--1-of-12 grid-col--centered grid-col animated fadeInDown"></a>
		...
		<div class="p2 right-nav  animated fadeInDown">
			...
			<a href="contact"><h3 class="cess-btn cess-active">Contact</h3></a>
		</div>
	</div>