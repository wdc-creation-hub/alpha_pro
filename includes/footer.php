<div class="text-center cess-footer container-fluid">
   
  <div class="row">
	  	<div class="col-md-12" style="background-color:#ce3030;height:8px"></div>
    <div class="col-md-12">
      <div class="col-md-4">
      ...
      <div class="col-md-4">
        <ul class="nav nav-pills nav-stacked">
          ...
          <li><a href="activities">Latest Activities</a></li>
        </ul>
      </div>
      <div class="col-md-4">
        <ul class="nav nav-pills nav-stacked">
